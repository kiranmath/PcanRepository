...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
       ...
       DailyBatteryData
        ...
        GenVehicleData_CurrentByPacks
        GenVehicleData_TMaxByPacks
         <p><a href="GenerateReport_Type01.aspx?VinID=204&ProcessDate=9/10/2015&ReportPeriod=DailyBatteryAllCust&ReportType=GenVehicleData_SoCByPacks_Min&WeekNumber=&YearNumber=">DailyBatteryData 3 &raquo;</a></p>
          <p><a href="GenerateReport_Type01.aspx?VinID=204&ProcessDate=9/10/2015&ReportPeriod=DailyBatteryAllCust&ReportType=GenVehicleData_SoCByPacks_Max&WeekNumber=&YearNumber=">DailyBatteryData 3 &raquo;</a></p>
  <p><a href="GenerateReport_Type01.aspx?VinID=204&ProcessDate=9/10/2015&ReportPeriod=DailyBatteryAllCust&ReportType=GenVehicleData_CurrentByPacks&WeekNumber=&YearNumber=">DailyBatteryData 3 &raquo;</a></p>
  <p><a href="GenerateReport_Type01.aspx?VinID=204&ProcessDate=9/10/2015&ReportPeriod=DailyBatteryAllCust&ReportType=GenVehicleData_TMaxByPacks&WeekNumber=&YearNumber=">DailyBatteryData 3 &raquo;</a></p>

             /DailyBatteryData
         <p><a href="GenerateTable_VinDashboard_Battery.aspx?CustomerId=7&ProcessDate=09/1/2015&ReportType=DailyBatteryData" class="btn btn-primary btn-large">DailyBatteryData &raquo;</a></p>
      
             <p><a href="GenerateTable_VinDashboard_Tabular.aspx?VinID=204&ProcessDate=9/4/2015&ReportPeriod=DailyBatteryAllCust&ReportType=DailyBatteryData&WeekNumber=&YearNumber=">DailyBatteryData 2 &raquo;</a></p>

              
            
        <p><a href="GenerateChart_SoC.aspx" class="btn btn-primary btn-large">GenVehicleData_aa &raquo;</a></p>
        <p><a href="GenerateReport_Type01.aspx?VinID=194&ProcessDate=08/22/2015&ReportType=GenVehicleData_SoC" class="btn btn-primary btn-large">GenVehicleData_SoC &raquo;</a></p>
      

         <p><a href="GenerateReport_Type01.aspx?VinID=194&ProcessDate=08/22/2015&ReportType=GenVehicleData_SoCEnergy" class="btn btn-primary btn-large">GenVehicleData_SoCEnergy &raquo;</a></p>
         <p><a href="GenerateReport_Type01.aspx?VinID=204&ProcessDate=8/31/2015&ReportType=GenVehicleData_SoCEnergy" class="btn btn-primary btn-large">GenVehicleData_SoCEnergy _204&raquo;</a></p>
               <p><a href="GenerateReport_Type01.aspx?VinID=177&ProcessDate=8/31/2015&ReportType=GenVehicleData_SoCEnergy" class="btn btn-primary btn-large">GenVehicleData_SoCEnergy &raquo;</a></p>
         <p><a href="GenerateReport_Type01.aspx?VinID=177&ProcessDate=8/31/2015&ReportPeriod=DailyBattery&ReportType=GenVehicleData_SoCByPacks_Min&WeekNumber=&YearNumber=" class="btn btn-primary btn-large">GenVehicleData_PieChart_ChargerStatus &raquo;</a></p>
           <a href="GenerateReport_Type01.aspx?VinID=177&ProcessDate=8/31/2015&ReportPeriod=DailyBattery&ReportType=GenVehicleData_SoCByPacks_Min" class="btn btn-primary btn-large">&ReportType=GenVehicleData_SoCByPacks_Min  &raquo;</a></p>

        

      <p><a href="GenerateChart_Pie.aspx?ChargingStationID=18&ReportPeriod=Weekly&WeekNumber=31&YearNumber=2015&ReportType=ChargerStatus" class="btn btn-primary btn-large">GenVehicleData_PieChart_ChargerStatus &raquo;</a></p>
      <p><a href="GenerateChart_Pie.aspx?ChargingStationID=18&ReportPeriod=Weekly&WeekNumber=31&YearNumber=2015&ReportType=ChargerFails" class="btn btn-primary btn-large">GenVehicleData_PieChart_ChargerFails &raquo;</a></p>
      <p><a href="GenerateChart_Type_Column.aspx?ChargingStationID=18&ReportPeriod=Weekly&WeekNumber=32&YearNumber=2015&ReportType=GenVehicleData_ChargerStatusHist" class="btn btn-primary btn-large">>GenVehicleData_ChargerStatusHist</a></p>


        
         -----------------------

        <p><a href="GenerateReport_Type01.aspx?VinID=232&ProcessDate=07/22/2015&ReportType=GenVehicleData_VinSpeed" class="btn btn-primary btn-large">GenVehicleData_VinSpeed &raquo;</a></p>
            <p><a href="GenerateReport_Type01.aspx?VinID=232&ProcessDate=08/22/2015&ReportType=GenVehicleData_SoC" class="btn btn-primary btn-large">GenVehicleData_SoC &raquo;</a></p>
         <p><a href="GenerateReport_Type01.aspx?VinID=232&ProcessDate=07/22/2015&ReportType=GenVehicleData_SoCEnergy" class="btn btn-primary btn-large">GenVehicleData_SoCEnergy &raquo;</a></p>
        

        ReportServices_DailyGrab_GenVehicleData_SOCEnergy
        <a href="GenerateTable_VinDashboard.aspx?VinID=177&ProcessDate=7/6/2015&ReportPeriod=Daily&ReportType=TempData&WeekNumber=&YearNumber=" class="btn btn-primary btn-large">Daily Dash  &raquo;</a></p>
        ...
        =================================
            ...
            <p><a href="GenerateChart_Type_Column.aspx?VinID=232&ProcessDate=7/22/2015&ReportType=GenVehicleData_VinSpeed" class="btn btn-primary btn-large">>GenVehicleData_VinSpeedHist</a></p>
